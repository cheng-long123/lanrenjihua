<template>
    <view id="alterPsd">
		<view class="alterPsd-box">
			<view class="alterPsd-form">
				<input type="text" v-model="phone" placeholder="请输入手机号" />
			</view>
			<view class="alterPsd-form">

				<input type="password" v-model="password" placeholder="请输新入密码" />
			</view>
			<view class="alterPsd-form">
			...
			<wyb-button class="alterPsd-btn" width="90%" type="plain" :ripple="true" :radius="['20px']" @click="alterPsd">确认</wyb-button>
			<!-- <button class="alterPsd-btn" type="default" @click="alterPsd">
				注册
			</button> -->
