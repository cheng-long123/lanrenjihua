<template>
	<view class="shuokuan">
		<view class="user_info">
			<text>输入信息</text>
			<text style="font-size: 28rpx; color: #4481EB;" @click="toAddCreditCard">添加信用卡</text>
		</view>
		<view class="form">
			...
			<view class="user_card" @click="getXingList">
				 <text class="user_text" style="font-size: 28rpx; margin-bottom: 15rpx;" >信用卡号</text>
				<picker class="picker" :range="choosezfkh"  :value="index"  @change="getCradList">
